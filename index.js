...
const loadContent = (e) => {
    ...
    if (t === "Portfolio") {
        ...
        fetch(url).then(function(response) {
                ...
                document.getElementById('bg-img').style.backgroundImage = "url('./img/portfolio.jpg')";
        ...
        let tagline = "Hot Topics for education.";


        //Load by Default Home Page
        fetch(url).then(function(response) {
                return response.text();
                ...
                container.innerHTML = data;
                tag.innerHTML = tagline;
                document.getElementById('bg-img').style.backgroundImage = "url('./img/money.jpg')";
...
const selectContent = () => {
    ...
    let tagline = "Hot Topics that I enjoy always.";
